...
model_fullExperimentalParameters_dem_order = 
  brm(formula_full_dem_order, 
      data = selectedData,
      family = cumulative("probit", threshold = "flexible"),
      prior = c(set_prior("normal(-0.7140, 0.1362)", class = "Intercept", coef = "1"),
                set_prior("normal(-0.2514, 0.1350)", class = "Intercept", coef = "2"),
                set_prior("normal(0.0364, 0.1349)", class = "Intercept", coef = "3"),
                set_prior("normal(0.3689, 0.1350)", class = "Intercept", coef = "4"),
                set_prior("normal(0.7687, 0.1358)", class = "Intercept", coef = "5"),
                set_prior("normal(1.4256, 0.1394)", class = "Intercept", coef = "6"),
                set_prior("normal(0.5451, 0.0883)", coef = "ConditionAsync"),
                set_prior("normal(-0.2457, 0.2743)", coef = "PositionLaying"),
                set_prior("normal(-0.3172, 0.1623)", coef = "LocationHand"),
                set_prior("normal(0.0835, 0.1488)", coef = "Previous_ExposureRobotmanipulation"),
                set_prior("normal(-0.1676, 0.4467)", coef = "Cognitive_LoadYes"),
                set_prior("normal(0.0606, 0.1625)", coef = "Duration_sec"),
                set_prior("normal(-0.1664, 0.0471)", coef = "Age"),
                set_prior("normal(-0.0948, 0.0605)", coef = "Gender_IsMaleMale"),
                set_prior("normal(0.0987, 0.1957)", coef = "ConditionAsync:PositionLaying"),
                set_prior("normal(-0.1972, 0.1974)", coef = "ConditionAsync:LocationHand"),
                set_prior("normal(-0.3676, 0.1479)", coef = "ConditionAsync:Previous_ExposureRobotmanipulation"),
                set_prior("normal(0.1519, 0.2852)", coef = "ConditionAsync:Cognitive_LoadYes"),
                set_prior("normal(-0.0910, 0.1108)", coef = "ConditionAsync:Duration_sec"),
                set_prior("normal(-0.0173, 0.0621)", coef = "ConditionAsync:Age")),
      warmup = 2000, iter = 8000,
      cores = 4, chains = 4, 
      control = list(max_treedepth = 13), init=0)
...
ggsave("PE_Intercepts.svg", units="mm", width = 70, height = 70) # for all
...
tibble(x = seq(from = -3.5, to = 3.5, by = .01)) %>%
  ...
  theme(
        # title = element_blank(),
        text = element_text(size = fontsize_paper, family = "Arial"))
ggsave("PE_Intercepts_norm.svg", units="mm", width = 70, height = 70) # for all
...
figure_name = c("PE_Async.svg",
                "PE_BodyPosition.svg",
                "PE_BodyLocation.svg",
                "PE_Previousexposure.svg",
                "PE_CognitiveLoad.svg",
                "PE_Duration.svg",
                "PE_Age.svg",
                "PE_Async_BodyPosition.svg",
                "PE_Async_BodyLocation.svg",
                "PE_Async_PreviousExposure.svg",
                "PE_Async_CognitiveLoad.svg",
                "PE_Async_Duration.svg",
                "PE_Async_Age.svg",
                "PE_SexAtBirth.svg")
...
ggsave("PE_ConditionalEffects_Age.svg", units="mm", width = 70, height = 60) 
...
figureName = "PE_Interaction_Condition_Position.svg"
...
figureName = "PE_Interaction_Location_Hand.svg"
ggsave(figureName, units="mm", width = 35, height = 40)
...
figureName = "PE_Interaction_Condition_PreviousExp.svg"
ggsave(figureName, units="mm", width = 35, height = 40)
...
figureName = "PE_Interaction_Condition_CogLoad.svg"
ggsave(figureName, units="mm", width = 35, height = 40)
...
figureName = "PE_Interaction_Condition_Duration.svg"
ggsave(figureName, units="mm", width = 35, height = 40)
...
figureName = "PE_Interaction_Condition_Age.svg"
...
figureName = "PE_Interaction_Condition_Order.svg"
ggsave(figureName, units="mm", width = 35, height = 40)
...
figureName = "PE_Interaction_EHI.svg"
ggsave(figureName, units="mm", width = 42, height = 48, dpi=500)
...
figureName = "PE_Interaction_PDI.svg"
ggsave(figureName, units="mm", width = 42, height = 48, dpi=500)
...
figureName = "PE_ConditionalEffects_PDI.svg"
