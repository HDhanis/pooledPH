...
model_fullExperimentalParameters_dem_order = 
  brm(formula_full_dem_order, 
      data = selectedData,
      family = cumulative("probit", threshold = "flexible"),
      prior = c(set_prior("normal(-0.9771, 0.1347)", class = "Intercept", coef = "1"),
                set_prior("normal(-0.5816, 0.1337)", class = "Intercept", coef = "2"), 
                set_prior("normal(-0.1824, 0.1329)", class = "Intercept", coef = "3"),
                set_prior("normal(0.1114, 0.1327)", class = "Intercept", coef = "4"),
                set_prior("normal(0.5362, 0.1331)", class = "Intercept", coef = "5"),
                set_prior("normal(1.0984, 0.1360)", class = "Intercept", coef = "6"),
                set_prior("normal(-0.6181, 0.0910)", coef = "ConditionAsync"),
                set_prior("normal(0.1375, 0.2940)", coef = "PositionLaying"),
                set_prior("normal(-0.1324, 0.1591)", coef = "LocationHand"),
                set_prior("normal(0.0084, 0.1465)", coef = "Previous_ExposureRobotmanipulation"),
                set_prior("normal(-0.4565, 0.1590)", coef = "Duration_sec"),
                set_prior("normal(-0.0855, 0.0467)", coef = "Age"),
                set_prior("normal(0.0910, 0.0627)", coef = "Gender_IsMaleMale"),
                set_prior("normal(0.1467, 0.2134)", coef = "ConditionAsync:PositionLaying"),
                set_prior("normal(0.3380, 0.1934)", coef = "ConditionAsync:LocationHand"),
                set_prior("normal(0.1977, 0.1495)", coef = "ConditionAsync:Previous_ExposureRobotmanipulation"),
                set_prior("normal(-0.0820, 0.1127)", coef = "ConditionAsync:Duration_sec"),
                set_prior("normal(0.0556, 0.0623)", coef = "ConditionAsync:Age")),
      warmup = 2000, iter = 8000,
      cores = 4, chains = 4, 
      control = list(max_treedepth = 13), init=0)
